export const trainings = [
  ...
  {
    id: 6,
    slug: "environment-museum",
    title: "Rwanda Environment Museum",
    ...
    highlights: [
      ...
      "Lake Kivu region focus"
    ]
  },

  {
    id: 7,
    slug: "presidential-palace-museum",
    title: "Presidential Palace Museum",
    image: "/image/presidential.jpg",
    category: "Museum",
    description:
      "Former home of President Habyarimana, offering historical context about Rwanda’s political past.",
    highlights: [
      "Historical aircraft wreckage",
      "Political history",
...

  {
    ...
    image: "/image/kigali-memorial.jpg",
    category: "Memorial",
    description:
  ...
  {
    id: 11,
    slug: "gisozi-memorial",
    title: "Gisozi Memorial",
    image: "/image/gisozi.jpg",
    category: "Memorial",
    description:
      "Another name for the Kigali Genocide Memorial site, representing remembrance and national unity.",
    highlights: [
  ...
  {
    id: 12,
    slug: "bisesero-genocide-memorial",
    title: "Bisesero Genocide Memorial",
    image: "/image/bisesero.jpg",
    category: "Memorial",
    description:
